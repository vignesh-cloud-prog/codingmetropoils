...
const AiPage = () => {
  return (
    <>
        ...
        <div className='container'>
          <div className='heading-title'>
            ...
            <div className='offer-actions' style={{ marginTop: 30 }}>
              <ConsultationLink href={appointmentHref("ai")} intent='ai' location='ai' className='button-primary'>
                Get AI setup
              </ConsultationLink>
            </div>
          </div>
      ...
      <Banner intent='ai' title='Ready for an AI setup consultation?' cta='Get AI setup' trackLocation='banner' />
    </>
  )
}
